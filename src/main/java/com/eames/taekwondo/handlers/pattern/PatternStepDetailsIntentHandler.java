 ...
 */
public class PatternStepDetailsIntentHandler extends IntentHandler {

    // Initialize the Log4j logger.
    private static final Logger logger = LogManager.getLogger(PatternStepDetailsIntentHandler.class);

    /**
     * Default Constructor
     */
    public PatternStepDetailsIntentHandler() {
        logger.debug("Constructing PatternStepDetailsIntentHandler");
    }
    ...
    public boolean canHandle(HandlerInput input) {
        return input.matches(intentName("PatternStepDetailsIntent"));
    }
    ...
    public Optional<Response> handle(HandlerInput input) {
        ...
        logger.debug(new StringBuilder()
                .append("PatternStepDetailsIntentHandler (")
                ...
                if (currentStep != null) {
                    ...
                    responseBuilder
                            .withSpeech(new StringBuilder()
                                    .append(pattern.getNthMovement(currentStep.intValue()).getFullDescription())
                                    .toString()
                            );
                }
