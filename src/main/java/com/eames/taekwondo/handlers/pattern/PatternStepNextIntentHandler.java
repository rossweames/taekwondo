...
/**
 * This is the handler for the 'pattern next step' skill.
 *
 * TODO: Need unit tests for this class.
 */
public class PatternStepNextIntentHandler extends IntentHandler {

    // Initialize the Log4j logger.
    private static final Logger logger = LogManager.getLogger(PatternStepNextIntentHandler.class);

    /**
     * Default Constructor
     */
    public PatternStepNextIntentHandler() {
        logger.debug("Constructing PatternStepNextIntentHandler");
    }
    ...
    public Optional<Response> handle(HandlerInput input) {
        ...
        logger.debug(new StringBuilder()
                .append("PatternStepNextIntentHandler (")
        ...
        if (activePattern != null) {
            ...
            if (pattern != null) {
                ...
                if (currentStep != null) {
                    ...
                    if (currentStep < pattern.getMovementCount() + 1) {
                    ...
                    // There are no more steps.
                        ...
                        responseBuilder
                                .withSpeech(new StringBuilder()
                                        .append("We have completed the pattern.")
                                        .toString()
                                );
                    }
                }
