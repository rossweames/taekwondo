...
public abstract class Patterns {
    ...
    public static final Pattern KWANG_GAE = new Pattern("kwanggae","Kwang-Gae", "kwon-gay", Belts.FIRST_DAN, PatternDiagrams.LAND_SIGN, 39, Stances.HEAVEN_HANDS);
    public static final Pattern POE_EUN = new Pattern("poeeun","Poe-Eun", "poe-en", Belts.FIRST_DAN, PatternDiagrams.HORIZONTAL_LINE, 36, Stances.HEAVEN_HANDS);
    public static final Pattern GAE_BAEK = new Pattern("gaebaek","Gae-Baek", "gaybeck", Belts.FIRST_DAN, PatternDiagrams.VERTICAL_LINE, 44, Stances.PARALLEL_READY);
    ...
    public static final Pattern YON_GAE = new Pattern("yongae","Yon-Gae", "yahn-gay", Belts.FOURTH_DAN, PatternDiagrams.CROSS, 49, Stances.WARRIOR_READY_A);
