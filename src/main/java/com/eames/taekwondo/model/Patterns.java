...
public abstract class Patterns {
     ...
     * The json
     */
    public static final Pattern SA_JU_JIRU_GI = new Pattern("sa_ju_jiru_gi","Sa-Ju Jiru-Gi", "sah-jew gear-oo-gee", Belts.TENTH_GUP, PatternDiagrams.CROSS, 7, Stances.PARALLEL_READY);
    public static final Pattern SA_JU_MAK_GI = new Pattern("sa_ju_mak_gi","Sa-Ju Mak-Gi", "sah-jew mock-gee", Belts.TENTH_GUP, PatternDiagrams.CROSS, 8, Stances.PARALLEL_READY);
    public static final Pattern CHON_JI = new Pattern("chon_ji", "Chon-Ji", "chun-gee", Belts.NINTH_GUP, PatternDiagrams.CROSS, 19, Stances.PARALLEL_READY);
    public static final Pattern DAN_GUN = new Pattern("dan_gun","Dan-Gun", "don-goon", Belts.EIGHTH_GUP, PatternDiagrams.CAPITAL_I, 21, Stances.PARALLEL_READY);
    public static final Pattern DO_SAN = new Pattern("do_san","Do-San", "doe-sahn", Belts.SEVENTH_GUP, PatternDiagrams.STAIR_STEP, 24, Stances.PARALLEL_READY);
    public static final Pattern WON_HYO = new Pattern("won_hyo","Won-Hyo", "wahn-yo", Belts.SIXTH_GUP, PatternDiagrams.CAPITAL_I, 28, Stances.CLOSED_READY_A);
    public static final Pattern YUL_GOK = new Pattern("yul_gok","Yul-Gok", "yule-gook", Belts.FIFTH_GUP, PatternDiagrams.SCHOLAR_SIGN, 38, Stances.PARALLEL_READY);
    public static final Pattern JOONG_GUN = new Pattern("joong_gun","Joong-Gun", "joon-goon", Belts.FOURTH_GUP, PatternDiagrams.CAPITAL_I, 32, Stances.CLOSED_READY_B);
    public static final Pattern TOI_GYE = new Pattern("toi_gye","Toi-Gye", "tay-gay", Belts.THIRD_GUP, PatternDiagrams.SCHOLAR_SIGN, 37, Stances.CLOSED_READY_B);
    ...
    public static final Pattern KO_DANG = new Pattern("ko_dang","Ko-Dang", "ko-dang", Belts.SECOND_DAN, PatternDiagrams.CAPITAL_T, 39, Stances.CLOSED_READY_C);
    public static final Pattern SAM_IL = new Pattern("sam_il","Sam-Il", "sam-ill", Belts.THIRD_DAN, PatternDiagrams.CROSS, 33, Stances.CLOSED_READY_C);
    public static final Pattern YOO_SIN = new Pattern("yoo_sin","Yoo-Sin", "you-sin", Belts.THIRD_DAN, PatternDiagrams.FANCY_I, 68, Stances.WARRIOR_READY_A);
    public static final Pattern CHOI_YONG = new Pattern("choi_yong","Choi-Yang", "choy-yahng", Belts.THIRD_DAN, PatternDiagrams.CROSS, 46, Stances.CLOSED_READY_C);
    public static final Pattern YON_GAE = new Pattern("yon_gae","Yon-Gae", "yahn-gay", Belts.FOURTH_DAN, PatternDiagrams.CROSS, 49, Stances.WARRIOR_READY_A);
    public static final Pattern UL_JI = new Pattern("ul_ji","Ul-Ji", "uhl-gee", Belts.FOURTH_DAN, PatternDiagrams.Z_SIGN, 42, Stances.PARALLEL_X);
    public static final Pattern MOON_MOO = new Pattern("moon_moo","Moon-Moo", "moon-moo", Belts.FOURTH_DAN, PatternDiagrams.CROSS, 61, Stances.PARALLEL_READY);
    public static final Pattern SO_SAN = new Pattern("so_san","So-San", "so-sahn", Belts.FIFTH_DAN, PatternDiagrams.CROSS, 72, Stances.CLOSED_READY_A);
    public static final Pattern SE_JONG = new Pattern("se_jong","Se-Jong", "say-jong", Belts.FIFTH_DAN, PatternDiagrams.KING_SIGN, 24, Stances.CLOSED_READY_B);
    public static final Pattern TONG_IL = new Pattern("tong_il","Tong-Il", "tong-ill", Belts.SIXTH_DAN, PatternDiagrams.VERTICAL_LINE, 56, Stances.PARALLEL_OVER);
