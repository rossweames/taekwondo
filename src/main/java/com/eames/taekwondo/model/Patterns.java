...
public abstract class Patterns {
    ...
    public static final Pattern YUL_GUK = new Pattern("yulguk","Yul-Guk", "yule-gook", Belts.FIFTH_GUP, PatternDiagrams.SCHOLAR_SIGN, 37);
    ...
    public static final Pattern POE_EUN = new Pattern("poeeun","Poe-Eun", "poe-en", Belts.FIRST_DAN, PatternDiagrams.SCHOLAR_SIGN, 45);
    public static final Pattern GAE_BAEK = new Pattern("gaebaek","Gae-Baek", "gaybeck", Belts.FIRST_DAN, PatternDiagrams.SCHOLAR_SIGN, 45);
    public static final Pattern EUI_AM = new Pattern("euiam","Eui-Am", "ee-ahm", Belts.SECOND_DAN, PatternDiagrams.SCHOLAR_SIGN, 45);
    public static final Pattern CHOONG_JANG = new Pattern("choongjang","Choong-Jang", "choong-jang", Belts.SECOND_DAN, PatternDiagrams.SCHOLAR_SIGN, 45);
    public static final Pattern JUCHE = new Pattern("juche","Juche", "jew-chay", Belts.SECOND_DAN, PatternDiagrams.SCHOLAR_SIGN, 45);
    public static final Pattern KO_DANG = new Pattern("kodang","Ko-Dang", "ko-dang", Belts.SECOND_DAN, PatternDiagrams.SCHOLAR_SIGN, 45);
    public static final Pattern SAM_IL = new Pattern("samil","Sam-Il", "sam-ill", Belts.THIRD_DAN, PatternDiagrams.SCHOLAR_SIGN, 45);
    public static final Pattern YOO_SIN = new Pattern("yoosin","Yoo-Sin", "you-sin", Belts.THIRD_DAN, PatternDiagrams.SCHOLAR_SIGN, 45);
    public static final Pattern CHOI_YONG = new Pattern("choiyong","Choi-Yang", "choy-yahng", Belts.THIRD_DAN, PatternDiagrams.SCHOLAR_SIGN, 45);
    public static final Pattern YON_GAE = new Pattern("yongae","Yon-Gae", "yahn-gay", Belts.FOURTH_DAN, PatternDiagrams.SCHOLAR_SIGN, 45);
    public static final Pattern UL_JI = new Pattern("ulji","Ul-Ji", "uhl-gee", Belts.FOURTH_DAN, PatternDiagrams.SCHOLAR_SIGN, 45);
    public static final Pattern MOON_MOO = new Pattern("moonmoo","Moon-Moo", "moon-moo", Belts.FOURTH_DAN, PatternDiagrams.SCHOLAR_SIGN, 45);
    public static final Pattern SO_SAN = new Pattern("sosan","So-San", "so-sahn", Belts.FOURTH_DAN, PatternDiagrams.SCHOLAR_SIGN, 45);
    public static final Pattern SE_JONG = new Pattern("sejong","Se-Jong", "say-jong", Belts.FIFTH_DAN, PatternDiagrams.SCHOLAR_SIGN, 45);
    public static final Pattern TONG_IL = new Pattern("tongil","Tong-Il", "tong-ill", Belts.FIFTH_DAN, PatternDiagrams.SCHOLAR_SIGN, 45);
